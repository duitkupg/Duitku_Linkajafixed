...
class Payment extends \Duitku\Linkajafixed\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_linkajafixedepay';
    const METHOD_REFERENCE = 'duitkulinkajafixedReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Linkajafixed\Block\Info\View';
    ...
    /**
     * @var \Duitku\Linkajafixed\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Linkajafixed\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Linkajafixed\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajafixedepay/merchantnumber');
  	 $apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajafixedepay/api_key');
    $amount = round($order->getBaseTotalDue());
    
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance(); 
    $FormKey = $objectManager->get('Magento\Framework\Data\Form\FormKey');
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epaylinkajafixed/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epaylinkajafixed/accept');
     ...
     * @return \Duitku\Linkajafixed\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaylinkajafixed/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaylinkajafixed/cancel', ['_secure' => $this->_request->isSecure()]);
    }
