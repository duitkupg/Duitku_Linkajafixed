...
namespace Duitku\Linkajafixed\Helper;
// include_once('Duitku/ApiRequestor.php');
// include_once('Duitku/DuitkuCore.php');
use Duitku\Linkajafixed\Helper\DuitkuConstants;
use Duitku\Linkajafixed\Helper\Duitku\Duitku_Linkajafixed_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var \Duitku\Linkajafixed\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Linkajafixed\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Linkajafixed\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_linkajafixedepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Linkajafixed_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Linkajafixed")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Linkajafixed\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
